...
async function updateStatus(index) {
  ...
  const response = await fetch(
    `https://bc-api-server.onrender.com/item/${trackData[index].trackingNo}`,
    {
  ...
  <tr>
    ...
    <td>
     <select name="" id='select-${index}' onchange="updateStatus(${index})">
                        ...
                        <option value="Hold (Your goods has been seized- Please contact: - (956) 332-2899 or email:  BluCargooShippingCompany@Consultant.com)">On Hold </option>
                      </select>
   </td>
    <td class="tabled">
